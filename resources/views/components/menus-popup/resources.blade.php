<!-- Dropdown -->
<div class="z-50 absolute left-32 top-[60%] lg:left-auto lg:top-auto transition delay-150 duration-300 ease-in-out" x-show="open" @click.outside="open = false">
            ...
            <div>
                ...
                <div class="my-2">
                    <ul class="-mt-1 px-6 py-2 text-sm">
                        <li>
                            <a class="flex items-center py-2" href="{{ route('resources.index') }}"><span
                                    class="font-medium text-[15px] tracking-[-1%] text-gray-600 hover:text-black transition">Black Pages</span></a>
                        </li>
                    </ul>
                </div>
            </div>
