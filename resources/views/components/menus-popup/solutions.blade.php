<!-- Dropdown -->
 <div class="z-50 absolute left-32 top-[35%] lg:left-auto lg:top-auto transition delay-150 duration-300 ease-in-out" x-show="open" @click.outside="open = false">
    <div class="bg-white shadow-lg rounded-2xl transition delay-150 duration-300 ease-linear">
        <div class="flex">
            <div>
                <p class="px-6 py-2 text-lg text-gray-700 border-b font-bold text-center tracking-[-1%]">
                    @lang('messages.solutions_title')
                </p>
                <div class="my-2">
                    <ul class="-mt-1 px-6 py-2 text-sm">
                        <li>
                            <a class="flex items-center py-2" href="{{ route('mobile-invoice.index') }}"><span
                                    class="font-medium text-[15px] tracking-[-1%] text-gray-600 hover:text-black transition">@lang('messages.mobile_invoicing')</span></a>
                        </li>
                        <li>
                            <a class="flex items-center py-2" href="{{ route('expense-tracking.index') }}"><span
                                    class="font-medium text-[15px] tracking-[-1%] text-gray-600 hover:text-black transition">@lang('messages.expense_tracking')</span></a>
                        </li>
                        <li>
                            <a class="flex items-center py-2" href="{{ route('production-management.index') }}"><span
                                    class="font-medium text-[15px] tracking-[-1%] text-gray-600 hover:text-black transition">@lang('messages.production_management')</span></a></li>
                        <li>
                            <a class="flex items-center py-2" href="{{ route('inventory.index') }}"><span
                                    class="font-medium text-[15px] tracking-[-1%] text-gray-600 hover:text-black transition">@lang('messages.inventory')</span></a>
                        </li>
                        <li>
                            <a class="flex items-center py-2" href="{{ route('customers-management.index') }}"><span
                                    class="font-medium text-[15px] tracking-[-1%] text-gray-600 hover:text-black transition">@lang('messages.customer_management')</span></a></li>
                        <li>
                            <a class="flex items-center py-2" href="{{ route('customers-retention.index') }}"><span
                                    class="font-medium text-[15px] tracking-[-1%] text-gray-600 hover:text-black transition">@lang('messages.customer_retention')</span></a>
                        </li>
                        <li>
                            <a class="flex items-center py-2" href="{{ route('ar-ap-management.index') }}"><span
                                    class="font-medium text-[15px] tracking-[-1%] text-gray-600 hover:text-black transition">@lang('messages.arap_management')</span></a>
                        </li>
                        <li>
                            <a class="flex items-center py-2" href="{{ route('automation.index') }}"><span
                                    class="font-medium text-[15px] tracking-[-1%] text-gray-600 hover:text-black transition">@lang('messages.automation')</span></a>
                        </li>
                        <li>
                            <a class="flex items-center py-2" href="{{ route('approval-workflow.index') }}"><span
                                    class="font-medium text-[15px] tracking-[-1%] text-gray-600 hover:text-black transition">@lang('messages.approval_workflow')</span></a>
                        </li>
                        <li>
                            <a class="flex items-center py-2" href="{{ route('telegram-integration.index') }}"><span
                                    class="font-medium text-[15px] tracking-[-1%] text-gray-600 hover:text-black transition">@lang('messages.telegram_integration')</span></a>
                        </li>
                    </ul>
                </div>
            </div>
